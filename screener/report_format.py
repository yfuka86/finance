"""
Stock Report Evaluation Format v1.0
====================================
統一評価フォーマット: 定量スコア + 定性判断

評価軸 (各10点満点, 合計100点):
  1. バリュエーション (20点) — PER/fPER/PBR/MIX
  2. 財務健全性 (15点)       — 現金比率, BPS成長
  3. 成長性 (15点)           — fPER vs PER, 売上/利益成長
  4. テクニカル (20点)       — RSI, MACD, MA, 底値反発
  5. 需給 (10点)             — 出来高変化率, 売買代金
  6. カタリスト (10点)       — 決算近接度, 株主還元
  7. リスク (10点, 減点方式) — 流動性リスク, バリュートラップ兆候
